...
The origianl author's github repo can be found [here](https://github.com/freundTech/logi-z407-reverse-engineering). Without this person, my project would not exist.

# Logi Z407 Reverse Engineering
